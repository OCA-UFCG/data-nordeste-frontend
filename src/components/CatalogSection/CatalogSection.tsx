...
const CatalogSection = ({ header }: { header?: SectionHeader }) => {
  ...
  return (
    <section className="w-full bg-grey-100 py-12" id={title}>
      <div className="mx-auto box-border max-w-[1440px] px-4 lg:px-20 h-full">
        <div className="flex h-full items-center justify-between gap-6 text-grey-1100">
