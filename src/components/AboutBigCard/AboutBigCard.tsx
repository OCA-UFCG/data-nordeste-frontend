    ...
    <section className="flex items-center justify-center w-full">
      <div className="flex flex-col items-left">
        ...
        <div className="flex flex-col lg:flex-row w-full overflow-hidden justify-between items-top my-5">
          <Image
            className="w-full h-full max-h-[400px] object-cover rounded-md aspect-[3/4] order-1 mb-5"
            src={`https:${thumb.fields.file.url}`}
            alt={"Sobre nós"}
            width={400}
            height={400}
          />
          <div className="h-full max-h-[400px] overflow-y-auto text-base text-gray-800 order-2 lg:pl-10">
